...
public class DDALineTool extends JPanel {
    ...
    private class DDAInnerCanvas extends JPanel {
        ...
        protected void paintComponent(Graphics g) {
            ...
            for (LineRecord line : lineList) {
                drawDDALine(g2, line.start, line.end);
            }

            if (firstClickPoint != null && currentMousePoint != null) {
                drawDDALine(g2, firstClickPoint, currentMousePoint);
            }
        ...
        private void drawDDALine(Graphics g, Point startPoint, Point endPoint) {
            int x1 = startPoint.x;
            int y1 = startPoint.y;
            int x2 = endPoint.x;
            int y2 = endPoint.y;
            ...
            double xIncrement = dx * 1.0 / steps;
            double yIncrement = dy * 1.0 / steps;
