...
public class BresenhamDrawTool implements ToolInterface {
    ...
    public JPanel getParameterPanel() {
        if (parameterPanel == null) {
            ...
            y1Field = createTextField("150");
            x2Field = createTextField("400");
            y2Field = createTextField("350");
    ...
    public void activate(DrawingCanvas canvas) {
        this.canvas = canvas;
        canvas.setCurrentTool("bresenham_line");
    }
    ...
    private void drawLineFromInput() {
        ...
        try {
            ...
            canvas.addLine(x1, y1, x2, y2, false);
